...
const INTERESTING_PROTOCOLS = ["0xacd43e627e64355f1861cec6d3a6688b31a6f952"]
const BALANCE_DIFF_THRESHOLD = "10000000"
...
function provideHandleTransaction(
  ...
  return async function handleTransaction(txEvent: TransactionEvent) {
    ...
    findings.push(
      Finding.fromObject({
        name: "Flash Loan",
        description: `Flash Loan over $10m detected for ${protocolAddress}`,
        alertId: "FORTA-5",
        protocol: "aave",
